...
/// </summary>
internal class WindowApplicationSettings(Window window) : ApplicationSettingsBase(window.GetType().FullName), IWindowPlacementSettings
{
    [UserScopedSetting]
    public WindowPlacementSetting Placement
    {
        get
        {
            ...
            catch (ConfigurationErrorsException ex)
            {
                ...
                throw new Exception($"The settings file '{filename ?? "<unknown>"}' seems to be corrupted", ex);
            }
        }
