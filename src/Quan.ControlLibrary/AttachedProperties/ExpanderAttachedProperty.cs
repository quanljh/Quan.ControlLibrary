...
namespace Quan.ControlLibrary
{
    ...
    public static class ExpanderAttachedProperty
    {
        ...
        public static readonly DependencyProperty ExpanderLeftStyleProperty = DependencyProperty.RegisterAttached("ExpanderLeftStyle", typeof(Style), typeof(ExpanderAttachedProperty), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.AffectsRender | FrameworkPropertyMetadataOptions.AffectsMeasure));
        ...
        public static readonly DependencyProperty ExpanderRightStyleProperty = DependencyProperty.RegisterAttached("ExpanderRightStyle", typeof(Style), typeof(ExpanderAttachedProperty), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.AffectsRender | FrameworkPropertyMetadataOptions.AffectsMeasure));
        ...
        public static readonly DependencyProperty ExpanderUpStyleProperty = DependencyProperty.RegisterAttached("ExpanderUpStyle", typeof(Style), typeof(ExpanderAttachedProperty), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.AffectsRender | FrameworkPropertyMetadataOptions.AffectsMeasure));
        ...
        public static readonly DependencyProperty ExpanderDownStyleProperty = DependencyProperty.RegisterAttached("ExpanderDownStyle", typeof(Style), typeof(ExpanderAttachedProperty), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.AffectsRender | FrameworkPropertyMetadataOptions.AffectsMeasure));
    }
}
