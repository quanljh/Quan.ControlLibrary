...
namespace Quan.ControlLibrary.Behaviors;

public class WindowsSettingBehavior : Behavior<QuanWindow>
{
    /// <inheritdoc />
    ...
    private void LoadWindowState()
    {
        ...
        {
            throw new Exception($"Failed to set the window state for {window} from the settings.", ex);
        }
    }
